---
layout: "manual"
title: "命令行调用 · synthesis 使用手册 · Noemion"
page_role: "docs-topic"
footer_text: "Noemion · synthesis 使用手册"
permalink: "/tools/synthesis/docs/invocation.html"
manual_id: "synthesis"
manual_group: "start"
manual_order: 4
nav_title: "命令行调用"
...
```text
synthesis [MAIN_OBJECT] [DOMAIN_ARCHIVE] --output [LINKED_OBJECT]
synthesis --shared [INPUT_OBJECTS] --lock [DEPENDENCY_LOCK] --output [HORIZON_OBJECT]
synthesis --relocatable [PARTIAL_OBJECTS] --output [COMBINED_OBJECT]
```
