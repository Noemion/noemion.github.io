...
| 会话建立、观察和受限运行 | [发布与运行](running.html)、[contract 会话契约](../../architecture/adr-0024-dromen-session-contract.html) |
| 证据范围、有效性和覆盖度 | [evidence 规范](../../specifications/evidence-entry.html)、[ADR-0022](../../architecture/adr-0022-iknem-evidence-and-appraisal.html) |
