...
项目背景入口此前先讲“新的软件边界”，随后列出 Endem、Synem、Dromen、Iknem 四个对象和四类外部系统责任。四个章节只有 1,121 个可见字符，没有责任表或按问题入口；首次阅读者需要先理解内部对象，才能恢复 Noemion 为什么与普通人的自然语言目标有关。“如何推进”又把未来验证顺序放在项目目的旁边，削弱了使命、当前边界和学习路径之间的层次。
