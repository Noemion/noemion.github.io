...
- [语义面与观察词去专名化提案](../spec/semantic-facet-terminology-proposal.md)发现同一问题也存在于 `rhem/semion/skena/telis/krin/apor/phain`：七项职责必须保留，但它们只是 Endem 内部语义面与结构化观察，不需要产品式专名。直白候选尚待人类职责匹配，不是现行字段或 Profile。
