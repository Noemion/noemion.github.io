...
- 状态：已接受为实施基线；实现语言、数值 ABI、CLI 与仓库名未冻结
- 日期：2026-07-12
- 影响范围：首个实现仓库、规范制品、测试向量、安全读取器、对象写入器、工具拓扑、GNU 技术采用与外部 AI 协议适配
...
- GNU Binutils 2.46 文档：https://sourceware.org/binutils/docs/
