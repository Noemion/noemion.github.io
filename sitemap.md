...
- [ADR-0012](https://noemion.github.io/architecture/adr-0012-rust-core-language.html) — bounded historical language evidence and the conditional Rust review baseline for a future producer structural core
...
- [ADR-0024](https://noemion.github.io/architecture/adr-0024-dromen-session-contract.html) — why persistent targets never carry permanent authority, and how each attempt rebinds subject, policy, environment, least privilege, budget, observation, drift, and disposal
