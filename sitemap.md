...
- [Background and boundaries](https://noemion.github.io/about/background.html) — why expression and semantic identity need separate engineering objects
...
- [Getting started](https://noemion.github.io/docs/getting-started.html) — problem background, core objects, and recommended reading order
...
- [Tools reference](https://noemion.github.io/docs/tools-reference.html) — responsibilities and status of the tool family
...
- [Implementation roadmap](https://noemion.github.io/development/implementation-roadmap.html) — phases, tool responsibilities, and completion criteria
