...
[查看完整生命周期](../architecture/endem-lifecycle.html) · [查看结果分层决定](../architecture/adr-0015-result-domains.html) · [查看 mene 时间决定](../architecture/adr-0016-mene-time-model.html) · [查看否定与缺席决定](../architecture/adr-0017-negation-and-absence.html) · [查看组件职责](../components/) · [查看测试要求](../development/testing.html)
