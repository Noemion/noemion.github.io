...
nav_title: "指南与参考"
page_heading: "指南与参考"
page_lead: "先说明 Noemion 为什么研究人类目标编译，再按你要解决的问题进入案例、架构、应用或规范资料。"
...
| 当前名称怎样读写，哪些只是设计标识 | [术语简化决定](../architecture/adr-0037-terminology-simplification.html) | 能找到现行名称、候选读法、精确机器标识和仍待验证的限制 |
| 制品怎样形成、组合和进入一次受限运行 | [架构设计](architecture-guide.html) | 能定位 producer、inspector、runner 及其信任边界 |
| 项目已经完成什么，后续准备验证什么 | [项目进展](../development/) | 能分开已有成果、正在研究、待定内容和限制条件 |
