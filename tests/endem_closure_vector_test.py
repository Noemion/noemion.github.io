...
VECTOR_PATH = ROOT / "vectors" / "endem-closure" / "cases.json"
CASE_ID = re.compile(r"^CLOSURE-(?:VALID|REJECT)-[A-Z0-9-]+-[0-9]{3}$")
CLAUSES = {"CLOSURE-CLS-001", "CLOSURE-RES-001", "CLOSURE-GRF-001", "CLOSURE-AUT-001", "CLOSURE-STA-001", "CLOSURE-ACT-001"}


def proposal_violation(case):
    proposal = case.get("proposal")
    if not isinstance(proposal, dict):
        return "CLOSURE-CLS-001"
