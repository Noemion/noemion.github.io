...
更强的状态恢复责任见[记忆、检查点与恢复研究提案](https://noemion.github.io/spec/memory-checkpoint-and-resumption-proposal.html)；模型、控制面、凭据、适配器和观察通道怎样隔离，见[模型、适配器与能力域隔离研究提案](https://noemion.github.io/spec/model-adapter-isolation-proposal.html)。两者仍是非规范研究，不修改 SESSION-CORE。
