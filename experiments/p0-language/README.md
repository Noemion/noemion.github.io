...
本实验比较 C17 与安全 Rust 对同一组不可信 END-P0 字节的解释。它只回答首版固定前导、记录目录、范围、对齐、六记录基数和空映射载荷能否由小型实现稳定拒绝；不解析完整六语义面，不写 Endem，也不评估 CLI、Endem closure、evidence entry 或 bounded runner。
